...
public class ProducerAPI {
	...
	public static void main(String[] args) {
		...
		// The "all" setting we have specified will result in blocking on the full
		// commit of the record, the slowest but most durable setting.
...
//			producer.send(new ProducerRecord<String, String>("foo", i % 4, Integer.toString(i), Integer.toString(i)));
			ProducerRecord<String,String> record = new ProducerRecord<String, String>("alarm-842636425", 0, null, "test-" + i);
